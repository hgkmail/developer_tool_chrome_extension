    ...
    <div class="home-page">
        ...
        <div class="stats-row">
            <el-card class="stat-card" shadow="hover">
                <div class="stat-inner">
                    ...
                    <div class="stat-info">
                        <div class="stat-value">{{ TOOL_LIST.length }}</div>
                        <div class="stat-label">{{ t('home.totalTools') }}</div>
                    </div>
                </div>
            </el-card>
        </div>
        ...
        <template v-if="groupedTools.length">
            <template v-for="group in groupedTools" :key="group.key">
                ...
                <div class="tool-grid">
                    <el-card v-for="tool in group.tools" :key="tool.key" class="tool-card" shadow="hover"
                        @click="openTool(tool)">
                        <div class="tool-card-inner">
                            <el-icon :size="28" class="tool-icon">
                                <component :is="tool.icon" />
